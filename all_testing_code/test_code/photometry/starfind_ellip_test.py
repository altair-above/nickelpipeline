...
phot_data_3 = analyze_sources(image, plot=True, thresh=8.0, fittype='elliptical')
...
phot_data_4 = analyze_sources(image, plot=True, thresh=8.0, fittype='elliptical')
...
phot_data_5 = analyze_sources(image, plot=True, thresh=8.0, fittype='elliptical')
